# Codigo 85 - A State Capitals Quiz

## ¿Que hace?
- Es un juego de adivinar las capitales.

## Descripcion
- Una vez que se tiene una herramienta para elegir una linea al azar de un archivo, no hay limite para los tipos de juegos de adivinar. Como este que es adivinar las capitales de los 50 estados de los Estados Unidos.
...
while [ "$guess" != "quit" ] ; do
    ...
    state="$(echo $thiskey | cut -d\
    -f1 | sed 's/-/ /g')"
    city="$(echo $thiskey | cut -d\
    -f2 | sed 's/-/ /g')"
